                                        ...
                                        <div className="space-y-2 py-6">
                                            <Link
                                                ...
                                                className={`-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 hover:bg-gray-50 ${
                                                    isActive('/admin/dashboard') ? 'text-indigo-600 bg-indigo-50' : 'text-gray-900'
                                                }`}
                                            >
                                            ...
                                            <Link
                                                ...
                                                onClick={() => setIsMobileMenuOpen(false)}
                                                className={`-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 hover:bg-gray-50 ${
                                                    isActive('/admin/users') ? 'text-indigo-600 bg-indigo-50' : 'text-gray-900'
                                                }`}
                                            >
                                                <span className="flex items-center gap-3">
                                                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            ...
                                            <Link
                                                ...
                                                onClick={() => setIsMobileMenuOpen(false)}
                                                className={`-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 hover:bg-gray-50 ${
                                                    isActive('/admin/meetings') ? 'text-indigo-600 bg-indigo-50' : 'text-gray-900'
                                                }`}
                                            >
                                                <span className="flex items-center gap-3">
                                                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            ...
                                            <Link
                                                ...
                                                onClick={() => setIsMobileMenuOpen(false)}
                                                className={`-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 hover:bg-gray-50 ${
                                                    isActive('/admin/reclamations') ? 'text-indigo-600 bg-indigo-50' : 'text-gray-900'
                                                }`}
                                            >
                                                <span className="flex items-center gap-3">
                                                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
