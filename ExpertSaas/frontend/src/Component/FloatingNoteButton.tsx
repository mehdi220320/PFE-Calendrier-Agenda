    ...
    return (
        <div className="fixed bottom-8 right-8 z-50">
            ...
            {isOpen && (
                <div
                    ref={popupRef}
                    className="absolute bottom-16 right-0 mb-2 w-[480px] bg-white rounded-lg shadow-xl border border-gray-200 overflow-hidden animate-slide-up"
                >
                    {/* Header with Tabs */}
            ...
            {/* Floating Button - Changes color when popup is open */}
            <button
