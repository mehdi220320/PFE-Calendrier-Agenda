...
import AddBlockedSlot from './components/AddBlockedSlot';
import AddBreakModal from './components/AddBreakModal';
import Header from "../../Component/Header";
import AvailabilityOverrideSection from './components/AvailabilityOverrideSection';
...
const PlanificationPage: React.FC = () => {
    ...
    const handleDaySelection = (dayValue: number) => {
        setFormData(prev => {
            ...
            return { ...prev, dayOfWeek: currentDays };
        });
    ...
    const validateForm = (): boolean => {
        ...
        if (formData.dayOfWeek.length === 0) errors.dayOfWeek = 'Sélectionnez au moins un jour';
        ...
        if (formData.slotDuration < 5) errors.slotDuration = 'La durée minimale est de 5 minutes';
        if (formData.slotDuration > 120) errors.slotDuration = 'La durée maximale est de 120 minutes';
    ...
    const handleEdit = () => {
        if (availability) setFormData(availability);
        setShowForm(true);
    };
        ...
        <>
                ...
                <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4 mb-8">
                        <div className="bg-white overflow-hidden rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-300">
                            <div className="p-6">
                                <div className="flex items-center">
                                    <div className={`flex-shrink-0 rounded-lg p-3 ${availabilityExists ? 'bg-green-100' : 'bg-yellow-100'}`}>
                                        <svg className={`w-6 h-6 ${availabilityExists ? 'text-green-600' : 'text-yellow-600'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <div className="ml-5 w-0 flex-1">
                                        <dl>
                                            ...
                                            <dd><div className="text-lg font-medium text-gray-900">{availabilityExists ? 'Configurées' : 'Non configurées'}</div></dd>
                                        </dl>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="flex items-center">
                                    ...
                                    <div className="ml-5 w-0 flex-1">
                                        <dl>
                                            ...
                                            <dd><div className="text-lg font-medium text-gray-900">{availability ? availability.dayOfWeek.length : 0}/7</div></dd>
                                        </dl>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="flex items-center">
                                    ...
                                    <div className="ml-5 w-0 flex-1">
                                        <dl>
                                            ...
                                            <dd><div className="text-lg font-medium text-gray-900">{availability ? `${availability.slotDuration} min` : 'Non définie'}</div></dd>
                                        </dl>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="bg-white overflow-hidden rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-300">
                            <div className="p-6">
                                <div className="flex items-center">
                                    <div className={`flex-shrink-0 rounded-lg p-3 ${breakData ? 'bg-amber-100' : 'bg-gray-100'}`}>
                                        <svg className={`w-6 h-6 ${breakData ? 'text-amber-600' : 'text-gray-600'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <div className="ml-5 w-0 flex-1">
                                        <dl>
                                            ...
                                            <dd><div className="text-lg font-medium text-gray-900">{breakData ? `${breakData.startAt} - ${breakData.endAt}` : 'Non configurée'}</div></dd>
                                        </dl>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="p-6">
                            {!availabilityExists && !showForm ? (
                                <div className="text-center py-12">
                                    ...
                                    <p className="text-gray-500 mb-4">Vous n'avez pas encore configuré vos disponibilités</p>
                                    <button
                                ...
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    <div className="bg-gray-50/50 p-6 rounded-xl border border-gray-200">
                                        ...
                                        <div>
                                            ...
                                            <div className={`grid grid-cols-2 md:grid-cols-4 gap-3 p-4 bg-white rounded-lg border ${formErrors.dayOfWeek ? 'border-red-500' : 'border-gray-200'}`}>
                                                {daysOfWeek.map(day => (
                                                    <label
                                                        key={day.value}
                                                    ...
                                                    >
                                                        ...
                                                        />
                                                        <span className={`text-sm font-medium ${formData.dayOfWeek.includes(day.value) ? 'text-indigo-700' : 'text-gray-700'}`}>
                                                            {day.label}
                                                        </span>
                                                    </label>
                                                ))}
                                            ...
                                            {formErrors.dayOfWeek ? (
                                                ...
                                                <p className="mt-2 text-xs text-gray-500">Sélectionnez un ou plusieurs jours de la semaine</p>
                                            )}
                                        </div>
                                    </div>
                                            ...
                                            <div>
                                                ...
                                                <div className="relative">
                                                    <input
                                                        ...
                                                        className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 ${formErrors.startTime ? 'border-red-500' : 'border-gray-300'}`}
                                                    />
                                            ...
                                            <div>
                                                ...
                                                <div className="relative">
                                                    <input
                                                        ...
                                                        onChange={handleInputChange}
                                                        className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 ${formErrors.endTime ? 'border-red-500' : 'border-gray-300'}`}
                                                    />
                                    ...
                                    <div className="bg-gray-50/50 p-6 rounded-xl border border-gray-200">
                                        ...
                                        <div>
                                            <label className="block text-sm font-medium text-gray-700 mb-1">Durée des créneaux (minutes) *</label>
                                            <div className="relative max-w-xs">
                                                <input
                                                    ...
                                                    max="120"
                                                    step="5"
                                                    className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 ${formErrors.slotDuration ? 'border-red-500' : 'border-gray-300'}`}
                                                />
                                                {formErrors.slotDuration && <p className="mt-1 text-xs text-red-500">{formErrors.slotDuration}</p>}
                                                <p className="mt-2 text-xs text-gray-500">Durée de chaque créneau de rendez-vous (entre 5 et 120 minutes)</p>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <AvailabilityOverrideSection availability={availability} today={today} />
                                ...
                                <div className="p-6">
                                    <div className="bg-amber-50 rounded-lg p-4 border border-amber-200">
                                        <div className="flex items-center justify-between">
                                            ...
                                            <p className="text-sm text-amber-700">Ces horaires sont exclus de vos disponibilités</p>
                                        </div>
                                    </div>
                                </div>
                            )}
                    ...
                    {availabilityExists && (
                        <div className="bg-white shadow-sm border border-gray-100 rounded-xl overflow-hidden mb-8">
                            ...
                            >
                                <div className="flex justify-between items-center">
                                    ...
                                    <div className="flex items-center gap-4">
                                        <button
                                            onClick={(e) => { e.stopPropagation(); setShowBlockedSlotModal(true); }}
                                        ...
                                        <svg
                                            className={`w-5 h-5 text-gray-400 transform transition-transform duration-200 ${showBlockedSlots ? 'rotate-180' : ''}`}
                            ...
                            <div className={`transition-all duration-300 ease-in-out overflow-hidden ${showBlockedSlots ? 'max-h-110' : 'max-h-0'}`}>
                                <div className="p-6 max-h-100 overflow-auto">
                                    {loadingBlockedSlots ? (
                                                    ...
                                                    <div className="flex items-center space-x-4">
                                                        ...
                                                        <div>
                                                            <div className="flex items-center space-x-2">
                                                                <span className="text-sm font-medium text-gray-900">{formatDate(slot.startDateTime)}</span>
                                                                <span className="text-gray-400">→</span>
                                                                <span className="text-sm font-medium text-gray-900">{formatDate(slot.endDateTime)}</span>
                                                            </div>
                                                            {slot.reason && (
                                                                <div className="mt-1">
                                        ...
                                        <div className="text-center py-8">
                                            ...
                                            <p className="mt-1 text-sm text-gray-500">Vous n'avez pas de créneaux bloqués à venir.</p>
                                        </div>
                                    )}
                                </div>
                            </div>
            ...
            {showBlockedSlotModal && (
                <AddBlockedSlot
                    ...
                    onSuccess={() => {
                        ...
                        if (showBlockedSlots) fetchBlockedSlots();
            ...
            {showBreakModal && (
                <AddBreakModal
                    ...
                    onSuccess={() => { setShowBreakModal(false); fetchBreak(); }}
