...
export const expertProfilService = {
    ...
    getExpertProfile: async (expertId: string): Promise<ExpertProfil> => {
        try {
            const response = await api.get<{ profile: ExpertProfil }>(`/client/byexpert/${expertId}`);
            return response.data.profile;
        } catch (e) {
            console.error(e);
            throw e;
    ...
    getExpertsByCategory: async (category: string): Promise<{ expertUser: User }[]> => {
        try {
            const response = await api.get(`/experts/${encodeURIComponent(category)}`);
            return response.data;
        } catch (e) {
            console.error(e);
            throw e;
    ...
    getAllExperts: async (): Promise<{ expertUser: User }[]> => {
        try {
